...
CREATE TABLE UP_LAYOUT_RESTRICTIONS(
  ...
  RESTRICTION_NAME VARCHAR2(128) NOT NULL ,
  RESTRICTION_VALUE VARCHAR2(128),
  RESTRICTION_TREE_PATH VARCHAR2(128) NOT NULL
);
...
DROP INDEX CALENDAR_USER_NAME_IDX;

ALTER TABLE UP_USER DROP CONSTRAINT UP_USER_USER_NAME_PKEY;
ALTER TABLE UP_PERSON_DIR DROP CONSTRAINT UP_PERSON_DIR_PKEY;

ALTER TABLE up_user MODIFY user_name varchar(50);
ALTER TABLE up_person_dir MODIFY user_name varchar(50);
ALTER TABLE up_person_dir MODIFY last_name varchar(50);
ALTER TABLE up_person_dir MODIFY first_name varchar(50);
ALTER TABLE up_person_dir MODIFY email varchar(150);
ALTER TABLE person_dir_attr MODIFY prefix varchar(25);
ALTER TABLE person_dir_attr MODIFY suffix varchar(25);
ALTER TABLE person_dir_attr MODIFY state varchar(64);
ALTER TABLE person_dir_attr MODIFY zip varchar(64);
ALTER TABLE topic MODIFY description varchar(2048);
ALTER TABLE offering MODIFY description varchar(2048);
ALTER TABLE offering MODIFY opt_offeringterm varchar(35);
ALTER TABLE ASSESSMENT_RESULT MODIFY USER_NAME varchar(50);
ALTER TABLE CHAT_USERS MODIFY USER_NAME varchar(50);
ALTER TABLE CALENDAR MODIFY USER_NAME varchar(50);
ALTER TABLE CHANNEL_PREFERENCE MODIFY USER_NAME varchar(50);
ALTER TABLE GRADEBOOK_SCORE MODIFY USER_NAME varchar(50);
ALTER TABLE NOTEPAD MODIFY USER_NAME varchar(50);
ALTER TABLE USER_ACTIVATION MODIFY USER_NAME varchar(50);
ALTER TABLE MEMBERSHIP MODIFY USER_NAME varchar(50);
ALTER TABLE PERSON_DIR_ATTR MODIFY USER_NAME varchar(50);
ALTER TABLE PERSON_DIR_METADATA MODIFY USER_NAME varchar(50);
...
ALTER TABLE up_group MODIFY description VARCHAR(2048);
...
ALTER TABLE UP_USER ADD INITIAL_LOGIN_DATE DATE;
